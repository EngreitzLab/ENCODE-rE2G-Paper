...
gene_id     = "HDAC6"
enhancer_id = "chrX:48800681-48801014"
...
plot = plot + scale_y_continuous(limits = c(0, 3.4), breaks=c(0, 1.0, 2, 3), labels=c("0.0", "1.0", "2.0", "3.0"))
plot = plot + scale_x_continuous(limits = c(0, 6), breaks=c(0, 2, 4, 6), labels=c("0.0", "2.0", "4.0", "6.0"))

plot = plot + theme(plot.margin = margin(t = 7, r = 7, b = 3, l = 14.5, unit = 'pt'))

ggsave(file="Figure_S3J.pdf", plot = plot, width = 100, height = 40, units = "mm", dpi = 1200)
ggsave(file="Figure_S3J.svg", plot = plot, width = 100, height = 40, units = "mm", dpi = 1200)
