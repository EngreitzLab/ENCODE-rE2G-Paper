...
# save plot to pdf
ggsave(filename = "results/manuscript/plots/fig4d_enhancer_activity.pdf", height = 3.5, width = 5.5)

# save top 10 assay performance to file for use in other analyses
write_tsv(bs_perf_top_assays, file = "results/manuscript/tables/fig4d_performance_top_assays.tsv")
```
...
ggsave(filename = "results/manuscript/plots/supplementary_fig6_enhancer_activity.pdf", height = 4,
       width = 9)
```
