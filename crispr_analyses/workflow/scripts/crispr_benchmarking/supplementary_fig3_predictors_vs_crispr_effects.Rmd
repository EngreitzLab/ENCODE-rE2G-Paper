---
title: "Supplementary Figure 3: Predictor scores vs. CRISPR effect size"
...
# save to pdf
outfile <- "results/manuscript/plots/supplementary_fig3_predictors_vs_crispr_effects_rasterized.pdf"
ggsave(filename = outfile, height = 14, width = 10)
```
