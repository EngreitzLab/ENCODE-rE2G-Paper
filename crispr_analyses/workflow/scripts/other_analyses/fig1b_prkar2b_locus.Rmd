...
dir.create("results/manuscript/plots/fig1b", showWarnings = FALSE, recursive = TRUE)
...
```{r detailedLocusPlot, fig.height=6, fig.width=10}
# combine all tracks into one list
detailed_tracks <- c(axis_track, genes_track, k562_e2g_track, k562_e2g_ext_track,
...
detailed_track_sizes <- c(0.6, 0.3, 0.5, 0.5, 0.5, 0.15, 0.6, 0.6, 0.15,
...
```{r savePlot1}
# save locus plot to output .pdf file
pdf("results/manuscript/plots/fig1b/fig1b_prkar2b_detailed_view.pdf", height = 5.5, width = 10)
plotTracks(trackList = detailed_tracks, chromosome = as.character(seqnames(locus)),
           from = start(locus), to = end(locus), sizes = detailed_track_sizes,
           background.title = "transparent", col.axis = "black", fontcolor.title = "black",
           fontface.title = 1, rotation.title = 0, cex.axis = 0.5, cex.title = 0.6, margin = 40)
...
pdf("results/manuscript/plots/fig1b/fig1b_e2g_dendrogram_allExperiments.pdf", height = 3, width = 10)
plot(dendro)
dev.off()
```
...
pdf("results/manuscript/plots/fig1b/fig1b_e2g_dendrogram_defaultExperiments.pdf", height = 3,
    width = 10)
plot(dendro_default)
dev.off()
```
...
```{r plotAllDNaseExperimets, fig.height=4.5, fig.width=10}
...
```{r savePlot2}
# save locus plot to output .pdf file
pdf("results/manuscript/plots/fig1b/fig1b_prkar2b_allExperiments.pdf", height = 4.5, width = 10)
plotTracks(trackList = e2g_score_tracks, chromosome = as.character(seqnames(locus)),
           from = start(locus), to = end(locus), background.title = "transparent",
           col.axis = "black", fontcolor.title = "black", fontface.title = 1,
           rotation.title = 0, cex.axis = 0.5, cex.title = 0.6, margin = 40)
...
```{r plotDefaultDNaseExperimets, fig.height=4.5, fig.width=10}
# create data tracks for ENCODE-E2G predictions in default samples
...
```{r savePlot3}
# save locus plot to output .pdf file
pdf("results/manuscript/plots/fig1b/fig1b_prkar2b_defaultExperiments.pdf", height = 4.5, width = 10)
plotTracks(trackList = e2g_score_tracks_default, chromosome = as.character(seqnames(locus)),
           from = start(locus), to = end(locus), background.title = "transparent",
           col.axis = "black", fontcolor.title = "black", fontface.title = 1,
           rotation.title = 0, cex.axis = 0.5, cex.title = 0.6, margin = 40)
...
```{r plotFullLocusPlot, fig.height=10, fig.width=10}
# combine all tracks into one list
...
```{r savePlot4}
# save full locus plot figure using default sample tracks to output .pdf file
pdf("results/manuscript/plots/fig1b/fig1b_prkar2b_full_view.pdf", height = 10, width = 10)
plotTracks(trackList = all_tracks, chromosome = as.character(seqnames(locus)), from = start(locus),
           to = end(locus), sizes = track_sizes_full, background.title = "transparent",
           col.axis = "black", fontcolor.title = "black", fontface.title = 1,
           rotation.title = 0, cex.axis = 0.5, cex.title = 0.6, margin = 40)
...
pdf("results/manuscript/plots/fig1b/fig1b_e2g_legend.pdf", height = 5, width = 10)
