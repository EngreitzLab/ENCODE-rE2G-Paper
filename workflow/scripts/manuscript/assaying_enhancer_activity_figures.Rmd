...
# manually rename some top assay models
# bs_perf_top_assays <- bs_perf_top_assays %>%
#   mutate(pred_name_long = case_when(
#     pred_name_long == "NCOR1 (ENCFF935VYF)" ~ "NCOR1 (1)",
#     pred_name_long == "NCOR1 (ENCFF241YVJ)" ~ "NCOR1 (2)",
#     TRUE ~ as.character(pred_name_long)
#   ))
...
# save plot to pdf
ggsave(filename = "results/manuscript/plots/main_fig5f_enh_activity.pdf", height = 3.5, width = 5.5)

# save top 10 assay performance to file for use in other analyses
write_csv(bs_perf_top_assays, file = "results/manuscript/tables/enh_activity_top_assays.csv")
```
...
bs_perf_hist <- bootstrapPerformanceIntervals(bs_perf_hist_bs, metric = "auprc", R = 1000)
...
ggsave(filename = "results/manuscript/plots/figS11_enhancer_activity.pdf", height = 4, width = 9)
```
