...
# save plot to pdf
ggsave("results/manuscript/plots/figS1.2_crispr_performance_heldout.pdf", height = 5, width = 8)
```
...
# save plot to pdf
ggsave("results/manuscript/plots/main_fig2d_crispr_prc_heldout.pdf", height = 4, width = 6.25)
```
...
# save plot to pdf
ggsave("results/manuscript/plots/figS1.2_all_crispr_performance_heldout.pdf", height = 4,
       width = 15)
```
