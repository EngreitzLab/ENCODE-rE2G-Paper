...
auprc <- bootstrapPerformanceIntervals(merged_combined_bs, metric = "auprc", R = 1000, conf = 0.95,
...
precision <- bootstrapPerformanceIntervals(merged_combined_bs, metric = "precision", 
                                           ...
                                           conf = 0.95, ci_type = "perc", ncpus = 2)
...
ggsave(filename = "results/manuscript/plots/figS8_additional_crispr_benchmarks.pdf", height = 8,
       width = 15)
```
